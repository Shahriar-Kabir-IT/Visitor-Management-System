...
if(isset($_POST['save']))
{
  ...
  $sql="insert into tblvisitorabm(FullName,Email,MobileNumber,Address,WhomtoMeet,Deptartment,ReasontoMeet) value(:fullname,:email,:mobnumber,:address,:meet,:department,:reason)";
