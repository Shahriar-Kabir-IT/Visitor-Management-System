            ...
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-black" style="height: 150px;">
                <div class="card-body" >
                  ...
                  <?php
                  //todays visitors
                  $query=mysqli_query($con,"select ID from tblvisitorabm where date(EnterDate)=CURDATE();");
            ...
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-black" style="height: 150px;">
                <div class="card-body">
                  ...
                  <?php
                  //Yesterdays visitors
                  $query1=mysqli_query($con,"select ID from tblvisitorabm where date(EnterDate)=CURDATE()-1;");
            ...
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-black" style="height: 150px;">
                <div class="card-body">
                  ...
                  $query2=mysqli_query($con,"select ID from tblvisitorabm where date(EnterDate)>=(DATE(NOW()) - INTERVAL 7 DAY);");
            ...
            <div class="col-md-3 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-black" style="height: 150px;">
                <div class="card-body">
                  ...
                  $query3=mysqli_query($con,"select ID from tblvisitorabm");
