<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        <li class="nav-item">
            <a class="nav-link" href="dashboard_ajl.php">
        ...
        if ($result && $result->AdminName === "Admin") {
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="reports">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="btndates_report_details_ajl.php">Visitor Report By Date</a></li>
                    </ul>
                </div>
            </li>
            ...
            ?>
            <li class="nav-item">
                <a class="nav-link" href="new_visitorajl.php">
                    <span class="menu-title">New Visitor</span>
                    <i class="mdi mdi-account menu-icon"></i>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="manage_visitorajl.php">
